    ...
    <div>
      ...
      <Article key ={key}>
        ...
        <SharedImg>
          <a>
            {
              !article.shared && article.video ? <ReactPlayer width ={"100%"} url={article.video}  sandbox="allow-cross-origin"/>
            
            :
            (
              article.sharedImg && <img src ={article.sharedImg}  alt ="" /*width={"60px"} height={"64px"} *//>
            )}
          </a>
        </SharedImg>
        <SocialCounts>
          <li>
            <button>
              <img src="/images/reaction1-icon.svg" alt=""/>
              <img src="/images/reaction2-icon.svg" alt=""/>
              <span>75</span>
            </button>
          </li>
          <li>
